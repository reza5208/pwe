...
const firebaseConfig = {
  apiKey: "AIzaSyDELY6vJs7TPkIz4h26of_4HJeIadZZst8",
  authDomain: "reza-apps.firebaseapp.com",
  projectId: "reza-apps",
  storageBucket: "reza-apps.appspot.com",
  messagingSenderId: "196496135130",
  appId: "1:196496135130:web:485aac30a76493eb27a6e3",
  measurementId: "G-5F0RW3KX43",
};
...
async function initializePage() {
  ...
  monthYearInput.value = `${currentDate.getFullYear()}-${String(
  ...
  document.getElementById("supervisorName").textContent =
    localStorage.getItem("supervisorName") || "Talib";
...
function exportToPDF() {
  ...
  doc.autoTable({
    startY: 42,
    head: [
      ["Tarikh", "Destinasi", "Clock-In", "Clock-Out", "OT Hours", "Tandatangan Anda", "Tandatangan Penyelia"],
    ],
    body: tableData,
